...
/**
 * @file   cpm_ParaManager_BndCommEx_CART.h
 * カーテシアン用パラレルマネージャクラスのインラインヘッダーファイル
 * @date   2012/05/31
 */

#ifndef _CPM_PARAMANAGER_BNDCOMMEX_CART_H_
#define _CPM_PARAMANAGER_BNDCOMMEX_CART_H_
...
cpm_ErrorCode
cpm_ParaManagerCART::BndCommS4DEx( T *array, int nmax, int imax, int jmax, int kmax, int vc, int vc_comm, int procGrpNo )
{
  cpm_ErrorCode ret;
...
template<class T> CPM_INLINE
cpm_ErrorCode
cpm_ParaManagerCART::BndCommS4DEx_nowait( T *array, int nmax, int imax, int jmax, int kmax, int vc, int vc_comm
...
template<class T> CPM_INLINE
cpm_ErrorCode
cpm_ParaManagerCART::wait_BndCommS4DEx( T *array, int nmax, int imax, int jmax, int kmax, int vc, int vc_comm
                                      , MPI_Request req[12], int procGrpNo )
{
  cpm_ErrorCode ret;
...
template<class T> CPM_INLINE
cpm_ErrorCode
cpm_ParaManagerCART::PeriodicCommS4DEx( T *array, int nmax, int imax, int jmax, int kmax, int vc, int vc_comm
...
template<class T> CPM_INLINE
cpm_ErrorCode
cpm_ParaManagerCART::packXEx( T *array, int nmax, int imax, int jmax, int kmax, int vc, int vc_comm
...
template<class T> CPM_INLINE
cpm_ErrorCode
cpm_ParaManagerCART::unpackXEx( T *array, int nmax, int imax, int jmax, int kmax, int vc, int vc_comm
...
template<class T> CPM_INLINE
cpm_ErrorCode
cpm_ParaManagerCART::packYEx( T *array, int nmax, int imax, int jmax, int kmax, int vc, int vc_comm
                            , T *sendm, T *sendp, int nIDm, int nIDp )
{
  if( !IsRankNull(nIDm) )
  {
...
template<class T> CPM_INLINE
cpm_ErrorCode
cpm_ParaManagerCART::unpackYEx( T *array, int nmax, int imax, int jmax, int kmax, int vc, int vc_comm
                              , T *recvm, T *recvp, int nIDm, int nIDp )
{
  if( !IsRankNull(nIDm) )
  {
...
template<class T> CPM_INLINE
cpm_ErrorCode
cpm_ParaManagerCART::packZEx( T *array, int nmax, int imax, int jmax, int kmax, int vc, int vc_comm
                            , T *sendm, T *sendp, int nIDm, int nIDp )
{
  if( !IsRankNull(nIDm) )
  {
...
template<class T> CPM_INLINE
cpm_ErrorCode
cpm_ParaManagerCART::unpackZEx( T *array, int nmax, int imax, int jmax, int kmax, int vc, int vc_comm
                              , T *recvm, T *recvp, int nIDm, int nIDp )
{
  if( !IsRankNull(nIDm) )
  {
...
#endif /* _CPM_PARAMANAGER_BNDCOMMEX_CART_H_ */
