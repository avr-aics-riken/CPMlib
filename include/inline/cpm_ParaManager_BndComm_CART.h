...
#ifndef _CPM_PARAMANAGER_BNDCOMM_CART_H_
#define _CPM_PARAMANAGER_BNDCOMM_CART_H_
...
cpm_ErrorCode
cpm_ParaManagerCART::BndCommS4D( T *array, int imax, int jmax, int kmax, int nmax, int vc, int vc_comm, int procGrpNo )
{
  cpm_ErrorCode ret;
...
template<class T> CPM_INLINE
cpm_ErrorCode
cpm_ParaManagerCART::BndCommS4D_nowait( T *array, int imax, int jmax, int kmax, int nmax, int vc, int vc_comm
...
template<class T> CPM_INLINE
cpm_ErrorCode
cpm_ParaManagerCART::wait_BndCommS4D( T *array, int imax, int jmax, int kmax, int nmax, int vc, int vc_comm
                                    , MPI_Request req[12], int procGrpNo )
{
  cpm_ErrorCode ret;
...
template<class T> CPM_INLINE
cpm_ErrorCode
cpm_ParaManagerCART::PeriodicCommS4D( T *array, int imax, int jmax, int kmax, int nmax, int vc, int vc_comm
                                    , cpm_DirFlag dir, cpm_PMFlag pm, int procGrpNo )
{
  ...
  // pack
  if( (ret = packX( array, imax, jmax, kmax, nmax, vc, vc_comm, sendmx, sendpx, nIDsmx, nIDspx )) != CPM_SUCCESS ) return ret;
  ...
  // unpack
  if( (ret = unpackX( array, imax, jmax, kmax, nmax, vc, vc_comm, recvmx, recvpx, nIDrmx, nIDrpx )) != CPM_SUCCESS ) return ret;
  ...
  // pack
  if( (ret = packY( array, imax, jmax, kmax, nmax, vc, vc_comm, sendmy, sendpy, nIDsmy, nIDspy )) != CPM_SUCCESS ) return ret;
  ...
  // unpack
  if( (ret = unpackY( array, imax, jmax, kmax, nmax, vc, vc_comm, recvmy, recvpy, nIDrmy, nIDrpy )) != CPM_SUCCESS ) return ret;
  ...
  // pack
  if( (ret = packZ( array, imax, jmax, kmax, nmax, vc, vc_comm, sendmz, sendpz, nIDsmz, nIDspz )) != CPM_SUCCESS ) return ret;
  ...
  // unpack
  if( (ret = unpackZ( array, imax, jmax, kmax, nmax, vc, vc_comm, recvmz, recvpz, nIDrmz, nIDrpz )) != CPM_SUCCESS ) return ret;
...
template<class T> CPM_INLINE
cpm_ErrorCode
cpm_ParaManagerCART::packX( T *array, int imax, int jmax, int kmax, int nmax, int vc, int vc_comm
...
template<class T> CPM_INLINE
cpm_ErrorCode
cpm_ParaManagerCART::unpackX( T *array, int imax, int jmax, int kmax, int nmax, int vc, int vc_comm
...
template<class T> CPM_INLINE
cpm_ErrorCode
cpm_ParaManagerCART::packY( T *array, int imax, int jmax, int kmax, int nmax, int vc, int vc_comm
                          , T *sendm, T *sendp, int nIDm, int nIDp )
{
  if( !IsRankNull(nIDm) )
  {
...
template<class T> CPM_INLINE
cpm_ErrorCode
cpm_ParaManagerCART::unpackY( T *array, int imax, int jmax, int kmax, int nmax, int vc, int vc_comm
                            , T *recvm, T *recvp, int nIDm, int nIDp )
{
  if( !IsRankNull(nIDm) )
  {
...
template<class T> CPM_INLINE
cpm_ErrorCode
cpm_ParaManagerCART::packZ( T *array, int imax, int jmax, int kmax, int nmax, int vc, int vc_comm
                          , T *sendm, T *sendp, int nIDm, int nIDp )
{
  if( !IsRankNull(nIDm) )
  {
...
template<class T> CPM_INLINE
cpm_ErrorCode
cpm_ParaManagerCART::unpackZ( T *array, int imax, int jmax, int kmax, int nmax, int vc, int vc_comm
                            , T *recvm, T *recvp, int nIDm, int nIDp )
{
  if( !IsRankNull(nIDm) )
  {
...
template<class T> CPM_INLINE
cpm_ErrorCode
cpm_ParaManagerCART::sendrecv( T *sendm, T *recvm, T *sendp, T *recvp, size_t nw, MPI_Request *req
...
#endif /* _CPM_PARAMANAGER_BNDCOMM_CART_H_ */
